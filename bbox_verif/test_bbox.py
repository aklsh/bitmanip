...
from instr_fmt import instrOpMapping
...
async def TB(dut, XLEN, instr, instr_name, single_opd, num_of_tests):
    ...
    for i in range (num_of_tests):
        ...
        rm_result = bbox_rm(instr_name, rs1, rs2, XLEN, instr)
...
base = 'RV64'
instrList = instrOpMapping(base)
#To run tests for RV32, change base = 'RV32'

#generates tests for instructions of RV32
if base == 'RV32':
    tf.add_option('XLEN', [32])
    tf.add_option(('instr_name', 'instr','single_opd'), instrList)
    #tf.add_option(('instr','instr_name','single_opd'), [(1, 'andn', 0)])
